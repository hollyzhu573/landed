...
import { updateContactField } from '@/src/app/networking/actions'
...
export default function ContactInlineEditCell({ id, field, value, display, type = 'text', className }: Props) {
  ...
  function save() {
    ...
    startTransition(() => updateContactField(id, field, trimmed || null))
  }
